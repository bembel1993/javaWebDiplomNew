...
@WebServlet(name = "SendMessageAdmin", urlPatterns = "/SendMessageAdmin")
public class SendMessageAdmin extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        getServletContext().getRequestDispatcher("/WEB-INF/views/privateOfficeAdmin.jsp").forward(request, response);
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            ListMessage.addMessage(new Message(name, mess));
            System.out.println("");
